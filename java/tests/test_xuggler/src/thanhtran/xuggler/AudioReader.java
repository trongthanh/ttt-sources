 ...
 * time you call {@link AudioReader#readPacket()}, attempts to decode
...
public class AudioReader extends AMediaCoderMixin
{
  ...
  AudioReader(IContainer container)
  {
   ...
   * from a {@link AudioReader} that has this parameter set to false.
   * 
   * </p>
   * 
   * <p>
  ...
  /** 
   * Prints the {@link AudioReader} class,
