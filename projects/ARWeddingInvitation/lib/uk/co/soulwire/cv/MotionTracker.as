...
package uk.co.soulwire.cv 
{
	...
	public class MotionTracker extends Point
	{
		...
		protected var _src : Video;
		protected var _now : BitmapData;
		protected var _old : BitmapData;

		protected var _blr : BlurFilter;
		private var _cmx : ColorMatrix;
		protected var _col : ColorMatrixFilter;
		protected var _box : Rectangle;
		protected var _act : Boolean;
