...
package examples {
	...
	public class ARAppBase extends Sprite {
		...
		protected var _staticImageURL: String = "images/static_envelop.png";
		protected var _staticBitmapMovie: Sprite;
		...
		private function _onLoadCode(e:Event):void {
			...
			_code = new FLARCode(32, 32, 90, 90);
			//for L pat:
			//_code = new FLARCode(4,4);
			...
			if (_webcam) {
				...
				trace("no webcam, load static image");
				loadStaticImage();
			}
		...
		protected function loadStaticImage():void {
			var loader: Loader = new Loader();
			loader.contentLoaderInfo.addEventListener(Event.COMPLETE, staticImageLoadCompleteHandler);
			loader.load(new URLRequest(_staticImageURL));
		}
		
		private function staticImageLoadCompleteHandler(e:Event):void {
			var loaderInfo: LoaderInfo = e.target as LoaderInfo;
			var bitmap: Bitmap = loaderInfo.content as Bitmap;
			bitmap.width = _width;
			bitmap.height = _height;
			
			_staticBitmapMovie = new Sprite();
			_staticBitmapMovie.addChild(bitmap);
