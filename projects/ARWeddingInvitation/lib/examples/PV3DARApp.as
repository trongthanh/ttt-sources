...
package examples {
	...
	public class PV3DARApp extends ARAppBase {
		...
		private function _onInit(e:Event):void {
			...
			_viewport.scaleX = 1024 / 320;
			_viewport.scaleY = 768 / 240; // FIXME
			_viewport.x = -4; // 4pix ???
		...
		public function stopDetect(): void {
		...
		private function _onEnterFrame(e:Event = null):void {
			...
			} else if (_staticBitmapMovie) {
				_capture.bitmapData.draw(_staticBitmapMovie);
			}
