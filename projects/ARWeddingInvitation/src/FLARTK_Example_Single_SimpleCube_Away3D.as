...
package 
{
	...
	public class FLARTK_Example_Single_SimpleCube_Away3D extends Sprite
	{
		 ...
		 */
		public function FLARTK_Example_Single_SimpleCube_Away3D()
		{
			this.init();
		}
		...
		protected function init():void
		{
			...
			// マーカーのパターンファイル
			this.markerPatternFile = 'data/L.pat';
		...
		private function paramLoad():void
		{
			...
			mf.addTarget(
				...
				{
					// 分割数(縦・横)、黒枠の幅(縦・横)
					markerPatternCode = new FLARCode(4, 4);
...
//			this.view3d.visible = true;
			...
			this.container.getChildByName('CUBE').visible = true;
		}
