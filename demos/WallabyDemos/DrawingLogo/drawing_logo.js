...
$(document).ready(function() {
	...
	$.preload( urls, {
		base:'http://thanhtran-sources.googlecode.com/svn/trunk/demos/WallabyDemos/DrawingLogo/drawing_logo_assets/svgblock_',
		ext:'.svg',
		onComplete:function( data ){
			imageLoad ++;
			var percent = Math.round((imageLoad / 507) * 100);
