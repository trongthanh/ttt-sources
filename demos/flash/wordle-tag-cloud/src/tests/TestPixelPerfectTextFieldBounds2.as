...
package tests {
	...
	public class TestPixelPerfectTextFieldBounds2 extends Sprite {
		...
		public function TestPixelPerfectTextFieldBounds2() {
			...
			var xPos: Number = -alphaBounds.width / 2 - alphaBounds.x;
			var yPos: Number  = -alphaBounds.height / 2 - alphaBounds.y;
			var left: Number = alphaBounds.x;
			var right: Number = tf.width - alphaBounds.x - alphaBounds.width;
			tf.x += (right - left) / 2;
			tf.y = yPos;
			alphaBounds.x += sprite.x + xPos;
			alphaBounds.y += sprite.y + yPos;
